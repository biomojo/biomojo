...
public class BenchmarkSample extends AbstractEntity {
	...
	public BenchmarkSample(Map<LinuxProcStatField, Object> info) {
		...
		this.systemMilliseconds = (long) info
				.get(LinuxProcStatField.SYSTEM_TIME);
		...
		this.childMajorFaults = (long) info
				.get(LinuxProcStatField.CHILD_MAJOR_FAULTS);
		this.childMinorFaults = (long) info
				.get(LinuxProcStatField.CHILD_MINOR_FAULTS);
		this.childUserMillis = (long) info
				.get(LinuxProcStatField.CHILD_USER_TIME);
		this.childSystemMillis = (long) info
				.get(LinuxProcStatField.CHILD_SYSTEM_TIME);
	}
