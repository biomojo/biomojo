...
public class AlphabetFilterCommand extends InputOutputCommand {
    ...
    public void run() {
        try {
            ...
            final Supplier<FastqSeq<DNA, SangerQuality>> supplier = new FastqSeqSupplier<>(
                    AlphabetId.DNA | IUPACVariant.WITH_AMBIGIGUITY, AlphabetId.QUALITY_SANGER);
            final SequenceInputStream<FastqSeq<DNA, SangerQuality>> inputStream = new FastqInputStream<>(
