...
public class GenericMapper extends AbstractCommandLinePreparer {
    @SuppressWarnings("unused")
    private static final Logger logger = LoggerFactory.getLogger(GenericMapper.class);

    protected GenericMapper(final String interpreter, final String programName, final String programSubdir) {
