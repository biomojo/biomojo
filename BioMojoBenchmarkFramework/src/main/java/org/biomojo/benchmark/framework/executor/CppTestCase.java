...
public class CppTestCase extends TestCase {
     ...
     * @param library
     */
    public CppTestCase(final Benchmark benchmark, final Library library) {
    ...
    public List<String> getCommandLine() {
        ...
        if (config.get(ConfigParams.KMER_LENGTH) != null) {
            commandLine.add(config.get(ConfigParams.KMER_LENGTH));
        }
        return commandLine;
    }
}
