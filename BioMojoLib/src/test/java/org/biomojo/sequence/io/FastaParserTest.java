...
public class FastaParserTest extends
		FastxParserTest<ByteSeq<? extends ByteAlphabet>> {
	private static final Logger logger = LoggerFactory
			.getLogger(FastaParserTest.class.getName());
	...
	public void testGoodData() throws IOException {
		testCopy(getTestDataFromClasspath("data/dna_sequences.fasta"), 1770,
				true);
	}
	 ...
	 */
	@Override
	protected SequenceInputStream<ByteSeq<? extends ByteAlphabet>> getInputStream(
			final byte[] testData, final int bufSize) {
	...
	protected ByteSeq<? extends ByteAlphabet> getSequence() {
		return new ByteSeqImpl<ByteAlphabet>(Alphabets.getAlphabet(AlphabetId.DNA
				| IUPACAlphabetVariant.WITH_ANY, ByteAlphabet.class));
	}
}
