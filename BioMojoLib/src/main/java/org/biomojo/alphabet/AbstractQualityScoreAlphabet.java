...
public class AbstractQualityScoreAlphabet extends AbstractAlphabet<Byte>
		implements QualityScoreAlphabet {

	private final int start;
	private final int end;

	protected AbstractQualityScoreAlphabet(final int id, final int start,
			final int end) {
		super(id);
		this.start = start;
		this.end = end;
	 ...
	 */
	@Override
	public byte[] getCanonical(final byte[] values, final int start,
			final int end) {
		return values;
	}
