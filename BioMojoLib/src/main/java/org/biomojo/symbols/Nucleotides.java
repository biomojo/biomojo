...
public class Nucleotides extends CommonSymbols {
	...
	public static final byte[] AMBIGUITY_SYMBOLS = { ANY, A_OR_G, C_OR_T,
			C_OR_G, A_OR_T, G_OR_T, A_OR_C, NOT_A, NOT_C, NOT_G, NOT_T };

	public static final byte[] DNA_SYMBOLS = { ADENINE, CYTOSINE, GUANINE,
			THYMINE };
	public static final byte[] RNA_SYMBOLS = { ADENINE, CYTOSINE, GUANINE,
			URACIL };

	public static final byte[] CORE_SYMBOLS = { ADENINE, CYTOSINE, GUANINE,
			URACIL, THYMINE };
