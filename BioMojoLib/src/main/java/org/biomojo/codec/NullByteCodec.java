...
public class NullByteCodec extends AbstractByteCodec implements ByteCodec {
	...
	public void encode(final ByteAlphabet alphabet, final byte[] encodedData,
			final int length, final byte symbol, final int index) {
	 ...
	 */
	@Override
	public Byte decode(final Alphabet<Byte> alphabet, final byte[] encodedData,
	 ...
	 */
	@Override
	public void encode(final Alphabet<Byte> alphabet, final byte[] encodedData,
			final Byte symbol, final int index) {
		encodedData[index] = symbol;
	}
